...
public class TestStepReporting {
	...
	public void header() {
		try {
			...
			printhtml.println(
					"<td width='20%' bgcolor='#CCCCFF' align='center'><b><font color='#000000' face='Tahoma' size='2'><i>Pass/Fail</i></font></b></td>");
			printhtml.println(
	...
	public void testStepReporting(String Expected, String Status, String Actual) {
		try {
			...
			printhtml.append(
					"<td width='12%' bgcolor='#FFFFDC' valign='middle' align='center' ><font color='#000000' face='Tahoma' size='2'>"
